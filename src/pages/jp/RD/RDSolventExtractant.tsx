  ...
  return (
    <>
      {/* <section className="s-top">
        <div className="s-txt container">
          <h5>
            ...
            &gt; <Link to="/jp/rd/business-roadmap"> R&amp;D</Link> &gt; <Link to="/jp/rd/solvent-extractant"></Link> 溶媒抽出剤
          </h5>
          <h1>溶媒抽出剤</h1>
          <ul className="fve">
            <li><Link to="/jp/rd/business-roadmap">事業・ロードマップ</Link></li>
            <li><Link to="/jp/rd/solvent-extractant" className="on">溶媒抽出剤</Link></li>
            <li><Link to="/jp/rd/water-treatment-solution">水処理・ソリューション</Link></li>
            <li><Link to="/jp/rd/energy-system">エネルギー・システム</Link></li>
            <li><Link to="/jp/rd/anode-material">陰極材素材</Link></li>
          </ul>
        </div>
      ...
      <div className="s-comm container">
        ...
        <h1>
          最近、二次電池の市場規模は2020年461億ドルから2030年推算3,<br />
      ...
      <section className="container rnd02 com-comm s-comm">
        ...
        <ul className="twoDiv">
          <li>
            <h5 className="wd80">
              需要が増加するにつれ、廃バッテリーに対するイシューも話題になっており、実際に電気自動車で発生する廃バッテリーの量は2025年より2030年に約7倍増えると判断され、これに合わせて廃バッテリーリサイクル市場も同じ年に60兆ウォン(KRW)規模に成長するはずです。<br />
              国内の二次電池産業で使われる正極材の原料物質は、ほとんど海外調達を通じて供給されているのが実情です。<br />
              実際、コバルトとリチウムの場合、わずか20%だけが自国から供給されており、他の金属も自足する水準が50%に達していません。<br />
              一方、中国の場合、バッテリー核心素材部門で70%以上の国産化を達成しています。 <br />
              国内バッテリー原料の輸入依存性を減らすためには、二次電池リサイクル技術の研究が必須的な実情です。<br /><br />
        ...
        <div className="container">
          ...
          <ul className="rnd02">
            <li>
              ...
              <div className="txt">
                <h2>正極材物質原料</h2>
                <h3>国内の二次電池市場の成長にもかかわらず、大部分の正極材物質の原料は国内に全無</h3>
            ...
            <li>
              ...
              <div className="txt">
                <h2>溶媒抽出剤</h2>
                <h3>原料抽出は溶媒抽出剤を使用した工程が最も高い抽出効率を示す</h3>
          ...
          <div className="under">
            ...
            <h5>国内最高の低費用、高純度の溶媒抽出剤の国産化、都市鉱山による資源富国化の新しいパラダイムを形成。</h5>
          </div>
        </div>
      </section>
      ...
      <section className="rnd02-05 s-comm">
        <div className="container ">
          <h1>都市鉱山による富国化。</h1>
          <div className="pdb20"></div>
          <h5>Black Mass内のCo、Ni、Li抽出のための溶媒抽出剤の合成及び抽出、工程廃水処理して、水処理工程が一つのCycleで運営。</h5>
