    ...
    <>
      ...
      <section className="container rnd02 com-comm s-comm">
        ...
        <ul className="twoDiv">
          <li>
            <h5>
              株式会社EAPHOSの最終事業・ロードマップであり、<br />2024年現在、溶媒抽出剤と水処理・ソリューションのR&amp;D進行で開発予定です。
            </h5>
          </li>
          <li></li>
        </ul>
          ...
          {selectedYear === 2024 && (
            ...
            >
              <div className="li_01" style={{ transitionDelay: "0.05s" }}>
                ...
                <div className="txt">
                  <h1>負極材素材 <span>2024年開発</span></h1>
                  <div className="line"></div>
                  <div className="inner">
                    <h2>負極材素材</h2>
                    <h5>
                      <span>製品 : </span>Si前駆体, CNT, 導電性高分子<br />
              ...
              <div className="li_02" style={{ transitionDelay: "0.15s" }}>
                ...
                <div className="txt">
                  <h1>エネルギー・システム <span>2024年開発</span></h1>
                  <div className="line"></div>
                  <div className="inner">
                    <h2>エネルギー・システム</h2>
                    <h5>
                      <span>製品 : </span>DC遮斷器及び限流器, フロー電池<br />
              ...
              <div className="li_03" style={{ transitionDelay: "0.25s" }}>
                ...
                <div className="txt">
                  ...
                  <div className="line"></div>
                  <div className="inner">
                    <h2 className="inline-title">水処理・ソリューション(WWT Solution)</h2>
                    <h5>
                      <div className="inline-market">
                        <span>製品 : </span>凝集/沈殿, ED, メンブレン<br />
                        <span>市場 : </span>Secondary Battery(二次電池), Semiconductor(半導体)
                      </div>
                    </h5>
                  </div>
                </div>
              ...
              <div className="li_04" style={{ transitionDelay: "0.35s" }}>
                ...
                <div className="txt">
                  ...
                  <div className="line"></div>
                  <div className="inner">
                    <h2 className="inline-title">工業用洗浄剤(Industrial Cleaner)</h2>
                    <h5>
                      <div className="inline-market">
                        <span>製品 : </span>Formulation , Synthesis<br />
                        <span>市場 : </span>Display(ディスプレイ), Semiconductor(半導体), Optics application(光学適用)
                      </div>
                    </h5>
                  </div>
                </div>
          ...
          {selectedYear === 2023 && (
            ...
            >
              ...
              <div className="txtdiv" style={{ transitionDelay: "0.2s" }}>
                <div className="txt">
                  <h1>THORE-PHOS SOLEX <span>2023年開発</span></h1>
                  <div className="line"></div>
                  <div className="inner">
                    <h2>溶媒抽出剤(Extraction Solvent)</h2>
                    <h5>
                      <span>製品 : </span>Synthesis (272, 204, 507, 973 & リチウム専用)<br />
                      <span>市場 : </span>Secondary Battery(二次電池)
                    </h5>
                  </div>
                </div>
