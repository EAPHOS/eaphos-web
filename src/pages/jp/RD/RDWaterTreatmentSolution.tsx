  ...
  return (
    <>
      ...
      <div className='s-comm container'>
        <div className='pdb20'></div>
        <h1>
          工程内に発生する Na<sub>2</sub>SO<sub>4</sub>
          (硫酸ナトリウム)を分離してリサイクル
        </h1>
      </div>
      ...
      <section className='container rnd03 com-comm s-comm'>
        ...
        <ul className='twoDiv'>
          <li>
            <h5>
              廃バッテリー工程内に発生する工程廃水には様々な種類の汚染物質が存在
              <br />
              TOC, H<sub>2</sub>SO<sub>4</sub>, NaOH, 微量の重金属, Na
              <sub>2</sub>SO<sub>4</sub> などが存在
            </h5>
          </li>
        </ul>
      </section>
