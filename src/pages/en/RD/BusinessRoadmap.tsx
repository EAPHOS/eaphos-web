    ...
    <>
      ...
      <section className="container rnd02 com-comm s-comm">
        ...
        <ul className="twoDiv">
          <li>
            <h5>
              This is the Final Business Roadmap of EA PHOS Co., Ltd, as of 2024, <br />we plan to develop solvent extractants and water treatment solutions through R&amp;D.
            </h5>
          </li>
          <li></li>
        </ul>
          ...
          {selectedYear === 2024 && (
            ...
            >
              <div className="li_01" style={{ transitionDelay: "0.05s" }}>
                ...
                <div className="txt">
                  <h1>Anode Materials <span>2024 Development</span></h1>
                  <div className="line"></div>
                  <div className="inner">
                    <h2>Anode Materials</h2>
                    <h5>
                      <span>Product : </span>Si Precursor, CNT, Conducting Polymer<br />
              ...
              <div className="li_02" style={{ transitionDelay: "0.15s" }}>
                ...
                <div className="txt">
                  <h1>Energy System <span>2024 Development</span></h1>
                  <div className="line"></div>
                  <div className="inner">
                    <h2>Energy System</h2>
                    <h5>
                      <span>Product : </span>DC Breaker & Fault Current Limiter, Flow Battery<br />
              ...
              <div className="li_03" style={{ transitionDelay: "0.25s" }}>
                ...
                <div className="txt">
                  ...
                  <div className="line"></div>
                  <div className="inner">
                    <h2 className="inline-title">Water Treatment Solution(WWT Solution)</h2>
                    <h5>
                      <div className="inline-market">
                        <span>Product : </span>Flocculation/Precipitation, ED, Membrane<br />
              ...
              <div className="li_04" style={{ transitionDelay: "0.35s" }}>
                ...
                <div className="txt">
                  ...
                  <div className="inner">
                    ...
                    <h5>
                      <div className="inline-market">
                        <span>Product : </span>Formulation , Synthesis<br />
                        <span>Market : </span>Display, Semiconductor, Optics application
                      </div>
                    </h5>
                  </div>
                </div>
          ...
          {selectedYear === 2023 && (
            ...
            >
              <div style={{ transitionDelay: "0.1s" }}>
                <p>
                  <img src={rnd0103} alt="THORE-PHOS SOLEX" className="res-img img-2023" />
                </p>
              </div>
              <div className="txtdiv" style={{ transitionDelay: "0.2s" }}>
                <div className="txt">
                  <h1>THORE-PHOS SOLEX <span>2023 Development</span></h1>
                  <div className="line"></div>
                  <div className="inner">
                    <h2>Extraction Solvent</h2>
                    <h5>
                      <span>Product : </span>Synthesis (272, 204, 507, 973 &amp; Lithium only)<br />
                      <span>Market : </span>Secondary Battery
                    </h5>
                  </div>
                </div>
