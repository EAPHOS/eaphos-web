...
import '../../../css/RDWaterTreatmentSolution.css'; // Responsive and style definitions
  ...
  return (
    <>
      <section className="visual-top">
        <img src={TopVisual} alt="Top visual image" className="top-img" />
      </section>
      ...
      <div className="s-comm container">
        ...
        <h1>
          Performing treatment according to the treatment method for each pollutant <br />
          by separating cations, anions, and TOC in wastewater through the ED electrode
        </h1>
      </div>
      ...
      <section className="container rnd03 com-comm s-comm">
        ...
        <ul className="twoDiv">
          <li>
            <h5>
              Performing treatment according to the treatment method for each pollutant by separating cations, anions, and TOC in wastewater through the ED electrode
            </h5>
          </li>
        </ul>
      </section>
      ...
      <div className="s-comm container">
        <div className="pdb20"></div>
        <h1>
          Recycling by separating Na<sub>2</sub>SO<sub>4</sub> (sodium sulfate) generated during the process
        </h1>
      </div>
      ...
      <section className="container rnd03 com-comm s-comm">
        ...
        <ul className="twoDiv">
          <li>
            <h5>
              There are TOC, H<sub>2</sub>SO<sub>4</sub>, NaOH, traces of heavy metals, Na<sub>2</sub>SO<sub>4</sub>, etc.
            </h5>
          </li>
        </ul>
      </section>
      ...
      <section className="container rnd03-02 s-pad-bt">
        ...
        <p className="center">
          <img src={Img02} className="res-img" alt="Na2SO4 separation diagram" />
        </p>
