  ...
  return (
    <>
      ...
      <div className='s-comm container'>
        ...
        <h1>
          Recently, the market size of secondary batteries is expected <br />
      ...
      <section className='container rnd02 com-comm s-comm'>
        ...
        <ul className='twoDiv'>
          <li>
            <h5 className='wd80'>
              As demand increases, the issue of waste batteries is also becoming
              a hot topic, and in fact, the amount of waste batteries generated
              from electric vehicles is expected to increase by about 7 times in
              2030 compared to 2025, and the waste battery recycling market is
              also expected to grow to KRW 60 trillion in the same year. <br />
              <br />
              Most of the raw materials for cathode materials used in the
              domestic secondary battery industry are supplied through overseas
              procurement.
              <br />
              <br />
              ...
              On the other hand, China has achieved more than 70% localization
              in the battery core material sector. In order to reduce the import
              dependence of domestic battery raw materials, research on
              secondary battery recycling technology is essential.
              <br />
              <br />
              Therefore, we will be able to lead the market through rapid
              response and research to the movement of the waste battery
              recycling international market.
            </h5>
          </li>
          <li>
            <p>
      ...
      <section className='rnd02-04 s-comm'>
        <div className='container'>
          ...
          >
            <li>
              ...
              <div className='txt'>
                ...
                <h3>
                  Despite the growth of the domestic secondary battery market,
                  most cathode material raw materials are non-existent in Korea.
                </h3>
                <h4>
                  The raw materials for cathode materials used in Korea depend
                  on imports.
                </h4>
              </div>
            </li>
            <li>
              ...
              <div className='txt'>
                ...
                <h3>
                  For raw material extraction, the process using a solvent
                  extractant shows the highest extraction efficiency.
                </h3>
                <h4>
                  Solvent extractants used in Korea depend on overseas markets.
                </h4>
              </div>
            </li>
          </ul>
          <div className='under'>
            ...
            <h5>
              Localization of the lowest-cost, high-purity solvent extractant in
              Korea. Formation of a new paradigm for{' '}
              <span>being a resource-rich country</span> through urban mining.
            </h5>
          </div>
        </div>
      </section>
      ...
      <section className='rnd02-05 s-comm'>
        <div className='container '>
          <h1>
            <span>Being a rich country</span> through urban mining
          </h1>
          <div className='pdb20'></div>
          <h5>
            Synthesis and extraction of solvent extractants for extracting Co,
            Ni, and Li in Black Mass, and the water treatment process operated
            as one cycle by treating process wastewater.
          </h5>
