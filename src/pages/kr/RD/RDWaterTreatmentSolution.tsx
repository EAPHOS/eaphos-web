  ...
  return (
    <>
      ...
      <div className='s-comm container'>
        ...
        <h1>
          ED 전극을 통해 폐수 내 양이온과 음이온, TOC를 분리하여 <br />각
          오염물질들의 처리 방법에 맞춰 처리 진행
        </h1>
      </div>
      ...
      <section className='container rnd03 com-comm s-comm'>
        ...
        <ul className='twoDiv'>
          <li>
            <h5>
              ED 전극을 통해 폐수 내 양이온과 음이온, TOC를 분리하여 각
              오염물질들의 처리 방법에 맞춰 처리 진행
            </h5>
          </li>
        </ul>
      ...
      <section className='container rnd03 com-comm s-comm'>
        ...
        <ul className='twoDiv'>
          <li>
            <h5>
              폐배터리 공정 내 발생되는 공정 폐수에는 다양한 종류의 오염물질들이
              존재
              <br />
              TOC, H2SO4, NaOH, 미량의 중금속, Na<sub>2</sub>SO<sub>4</sub> 등이
              존재
            </h5>
          </li>
        </ul>
