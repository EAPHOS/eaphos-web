    ...
    <>
      ...
      <section className="container rnd02 com-comm s-comm">
        ...
        <ul className="twoDiv">
          <li>
            <h5>
              주식회사 이에이포스의 최종 사업 로드맵이며,<br />
              2024년 현재 용매추출제와 수처리 솔루션 R&amp;D 진행으로 개발 예정입니다.
            </h5>
          </li>
          <li></li>
        </ul>
          ...
          {selectedYear === 2024 && (
            ...
            >
              <div className="li_01" style={{ transitionDelay: "0.05s" }}>
                ...
                <div className="txt">
                  <h1>음극재소재 <span>2024년 개발</span></h1>
                  <div className="line"></div>
                  <div className="inner">
                    <h2>음극재소재</h2>
                    <h5>
                      <span>제품 : </span>Si전구체, CNT, 전도성고분자<br />
              ...
              <div className="li_02" style={{ transitionDelay: "0.15s" }}>
                ...
                <div className="txt">
                  <h1>에너지 시스템 <span>2024년 개발</span></h1>
                  <div className="line"></div>
                  <div className="inner">
                    <h2>에너지 시스템</h2>
                    <h5>
                      <span>제품 : </span>DC 차단기 및 한류기, 흐름전지<br />
                      <span>시장 : </span>Energy
                    </h5>
                  </div>
                </div>
              ...
              <div className="li_04" style={{ transitionDelay: "0.35s" }}>
                ...
                <div className="txt">
                  ...
                  <div className="line"></div>
                  <div className="inner">
                    <h2 className="inline-title">공업용 세정제(Industrial Cleaner)</h2>
                    <h5>
                      <div className="inline-market">
                        <span>제품 :</span> Formulation, Synthesis<br />
                        <span>시장 :</span> Display, Semiconductor, Optics application
                      </div>
                    </h5>
                  </div>
                </div>
          ...
          {selectedYear === 2023 && (
            ...
            >
              ...
              <div className="txtdiv" style={{ transitionDelay: "0.2s" }}>
                <div className="txt">
                  <h1>THORE-PHOS SOLEX<span>2023년 개발</span></h1>
                  <div className="line"></div>
                  <div className="inner">
                    <h2>용매추출제(Extraction Solvent)</h2>
                    <h5>
                      <span>제품 : </span>Synthesis (272, 204, 507, 973 &amp; 리튬전용)<br />
                      <span>시장 : </span>Secondary Battery
                    </h5>
                  </div>
                </div>
